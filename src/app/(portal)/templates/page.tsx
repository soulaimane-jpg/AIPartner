...
> = {
  RESELLING: {
    ...
    headerBg: "bg-gradient-to-br from-amber-50/80 to-orange-50/40",
    iconBox: "bg-amber-100 text-amber-700 ring-1 ring-amber-200/60",
  ...
  CONSULTING: {
    ...
    headerBg: "bg-gradient-to-br from-violet-50/80 to-purple-50/40",
    iconBox: "bg-violet-100 text-violet-700 ring-1 ring-violet-200/60",
    navHover: "hover:border-violet-300 hover:bg-violet-50 hover:text-violet-700",
    lightbulb: "text-violet-600",
    checkIcon: "text-violet-600",
  },
  MANAGED: {
    icon: Shield,
    accent: "text-teal-700",
    badge: "border-teal-200 text-teal-700 bg-teal-50",
    headerBg: "bg-gradient-to-br from-teal-50/80 to-cyan-50/40",
    iconBox: "bg-teal-100 text-teal-700 ring-1 ring-teal-200/60",
    navHover: "hover:border-teal-300 hover:bg-teal-50 hover:text-teal-700",
    lightbulb: "text-teal-600",
  ...
  SUPPORT: {
    ...
    headerBg: "bg-gradient-to-br from-rose-50/80 to-pink-50/40",
    iconBox: "bg-rose-100 text-rose-700 ring-1 ring-rose-200/60",
    navHover: "hover:border-rose-300 hover:bg-rose-50 hover:text-rose-700",
    lightbulb: "text-rose-600",
  ...
  TRAINING: {
    ...
    navHover: "hover:border-primary/30 hover:bg-primary/[0.06] hover:text-primary",
